...
@app.route("/users/<username>", methods=['GET', 'PUT', 'PATCH', 'DELETE'])
...
@app.route("/places/<id>", methods=['GET', 'PATCH', 'DELETE'])
def route_place(id):
...
print json.dumps(nearest_binds({"AA:AA:AA:AA:AA:AA": 9, "BB:BB:BB:BB:BB:BB": 6, "CC:CC:CC:CC:CC:CC": 1})[0]['place'])
